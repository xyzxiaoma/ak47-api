...
export const STATIC_I18N_KEYS = [
  ...
  'Upstream quota exhausted; reset time unknown',
  'Upstream authentication failed',
  'Upstream rate limit; quota exhaustion unconfirmed',
  'Model temporarily unavailable',
  'Upstream temporarily unavailable',
  'Health probe did not succeed',
  ...
  'Probe scheduled. Refresh status to see the result.',
  'Schedule a small health probe for this key? This consumes a small amount of upstream credits and does not reveal the balance.',
  // Header navigation
  'Home',
  'Console',
  'Model Square',
