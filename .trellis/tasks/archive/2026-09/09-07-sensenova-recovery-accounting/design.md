...
Production acceptance correction: retained rate failures use max(60 seconds, provider Retry-After), without increasing the cooldown merely because the failure count grows. Generic health failures keep their existing 60/300/900-second escalation. Preserve already stored future deadlines, unknown-quota start spacing, and exclusive recovery ownership.
